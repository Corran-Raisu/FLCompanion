...
BOOL CLimitationsDlg::OnInitDialog() 
{
	...
	bOk = m_resizer.CreateSplitContainer(_T("InnerSplit"), IDC_FRAME_Factions, IDC_FRAME_Goods);
	bOk = m_resizer.SetAnchor(_T("InnerSplit"), ANCHOR_ALL);
	bOk = m_resizer.SetIsSplitterFixed(_T("InnerSplit"), TRUE);
	bOk = m_resizer.CreateSplitContainer(_T("OutterSplit"), IDC_FRAME_Systems, _T("InnerSplit"));
...
//	bOk = m_resizer.CreateSplitContainer(_T("Splitter1"), IDC_FRAME_Systems, IDC_FRAME_Factions);
//	bOk = m_resizer.SetAnchor(_T("Splitter1"), ANCHOR_LEFT);
//	bOk = m_resizer.SetAnchor(_T("Splitter1"), IDC_FRAME_Systems);
//	bOk = m_resizer.SetShowSplitterGrip(_T("Splitter1"), TRUE);
